...
const ToolsCard = ({ icon, title, description, href, onClick, variant = 'neutral' }: Props) => {
    const className = cn(
        "relative sheen-sweep-hover overflow-hidden group flex items-center gap-4 rounded-brand-16 p-6 border default-transition text-left w-full cursor-pointer",
